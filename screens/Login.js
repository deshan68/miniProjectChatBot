...
const Login = ({ navigation }) => {
  ...
  return (
    <View className="flex-1 items-center">
      ...
      <View className="mt-4">
        <Text
          className="text-red-800 text-[20px] font-semibold"
          style={{ fontFamily: "Ubuntumedium" }}
        >
          Login
        </Text>
      </View>
      ...
      <View className="flex ml-1 w-[90%] h-5.5 rounded-xl flex-row justify-between">
        <View className="flex flex-row space-x-1">
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Reset")}>
            <Text className="text-blue-900 font-semibold">Reset it</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <TouchableOpacity className="flex flex-row w-[90%] h-14 mt-4 rounded-lg bg-[#e1e1e1] items-center">
        ...
        />
        <Text className="ml-5 text-[18px] font-semibold">
